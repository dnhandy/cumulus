...
class InputFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input_file" do
    assert_difference('InputFile.count') do
      post input_files_url, params: { input_file: { job_file_id: @input_file.job_file_id, job_id: @input_file.job_id } }
    end
  ...
  test "should update input_file" do
    patch input_file_url(@input_file), params: { input_file: { job_file_id: @input_file.job_file_id, job_id: @input_file.job_id } }
